...
func _ready():
	...
	GlobalVariables.areaBossEnemy = 2 #0 blastydios, genidios, 2 laser
	#camera limit, beda tergantung sama mapnya
	$Level/Player/Camera2D.limit_bottom = 1032
	$Level/Player/Camera2D.limit_top = -576
	$Level/Player/Camera2D.limit_left = -925
	$Level/Player/Camera2D.limit_right = 1875

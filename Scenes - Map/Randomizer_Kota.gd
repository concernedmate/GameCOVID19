...
func _ready():
	...
	GlobalVariables.areaBossEnemy = 1 #0 blastydios, 1 genidios, 2 laser
	#camera limit, beda tergantung sama mapnya
	$Level/Player/Camera2D.limit_bottom = 1030
	$Level/Player/Camera2D.limit_top = -576
	$Level/Player/Camera2D.limit_left = -912
	$Level/Player/Camera2D.limit_right = 1850
